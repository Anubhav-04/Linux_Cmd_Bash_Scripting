...
main() {
  if  ! check_awscli; then
    ...
    KEY_NAME="aws-volume-key"
    SUBNET_ID=" subnet-0ada8910fb1e01dc0"
    SECURITY_GROUP_IDS="sg-046d75c8505b0cc3d"  # Add your security group IDs separated by space
    INSTANCE_NAME="Shell-Script-EC2-Updated"
